...
This is the public landing page only. It matches the clean NickWorks design but does not capture or control the PC. After a secure remote hostname is configured, edit `index.html` and replace `https://remote.YOUR_DOMAIN.com` with its exact HTTPS address.
